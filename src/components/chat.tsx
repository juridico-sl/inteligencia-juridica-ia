                  ...
                  m.role === "assistant" ? (
                    <ReactMarkdown
                      ...
                      components={{
                        ...
                        thead: ({ ...props }) => (
                          <thead className="bg-slate-100 text-slate-800 font-bold uppercase tracking-wider text-[11px]" {...props} />
                        ),
                        th: ({ ...props }) => (
                          <th className="px-3 py-2.5 border-b border-slate-200 font-bold text-slate-900 whitespace-nowrap" {...props} />
                        ),
                        td: ({ ...props }) => (
                        ...
                        h1: ({ ...props }) => (
                          <h3 className="text-base font-bold text-slate-950 mt-3 mb-1.5" {...props} />
                        ),
                        h2: ({ ...props }) => (
                          <h3 className="text-sm font-bold text-slate-950 mt-3 mb-1" {...props} />
                        ),
                        h3: ({ ...props }) => (
                          <h4 className="text-xs font-bold uppercase tracking-wider text-slate-800 mt-2 mb-1" {...props} />
                        ),
                      }}
                    >
                      {m.content}
